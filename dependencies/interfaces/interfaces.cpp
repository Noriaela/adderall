...
void interfaces::initialize( ) {
	...
	render_view = utilities::game::capture_interface( "engine.dll", "VEngineRenderView014" );
	...
	input = *reinterpret_cast< i_input** >( utilities::pattern_scan( GetModuleHandleA( "client.dll" ), "B9 ? ? ? ? F3 0F 11 04 24 FF 50 10" ) + 1 );
}